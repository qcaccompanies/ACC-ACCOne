...
if (Mobile.verifyElementVisible(findTestObject('Buat Pengajuan/Alert_Cabang_Harus_Diisi'), 0, FailureHandling.OPTIONAL)) {
    ...
    Mobile.tap(findTestObject('Buat Pengajuan/Saya_Tertarik_BTN'), 0)

    if (Mobile.verifyElementVisible(findTestObject('Buat Pengajuan/Alert_Perhitungan_Belum_Diisi'), 0, FailureHandling.STOP_ON_FAILURE)) {
        Mobile.tap(findTestObject('Buat Pengajuan/SImulasi_Hitung_Kredit'), 0)
        ...
        if (Mobile.verifyElementVisible(findTestObject('Buat Pengajuan/Alert_Cabang_Harus_Diisi'), 0, FailureHandling.OPTIONAL)) {
            ...
            Mobile.tap(findTestObject('Buat Pengajuan/Ajukan_Sekarang_Btn'), 0)
        }
    } else {
        Mobile.tap(findTestObject('Buat Pengajuan/Ajukan_Sekarang_Btn'), 0)
    }
