...
not_run: Mobile.tap(findTestObject('Buat Pengajuan Mobil Baru/Lama/SImulasi_Hitung_Kredit'), 0)

Mobile.tapAtPosition(570, 2000)
...
if (DP == 'Persen') {
    ...
    if (Mobile.verifyElementVisible(findTestObject('Buat Pengajuan Mobil Baru/Lama/30Persen', [('text') : DPPersen]), 0, 
...
if (Periode == '12') {
    Mobile.tapAtPosition(84, 1200)
} else if (Periode == '24') {
    Mobile.tapAtPosition(312, 1200)
} else if (Periode == '36') {
    Mobile.tapAtPosition(540, 1200)
} else if (Periode == '48') {
    Mobile.tapAtPosition(766, 1200)
} else if (Periode == '60') {
    Mobile.tapAtPosition(994, 1200)
}

if (PembayaranAsuransi == 'Credit') {
    Mobile.tap(findTestObject('Buat Pengajuan Mobil Baru/Baru/Credit_Radio'), 0, FailureHandling.STOP_ON_FAILURE)

    Mobile.delay(2, FailureHandling.STOP_ON_FAILURE)
} else if (PembayaranAsuransi == 'Cash') {
    Mobile.tap(findTestObject('Buat Pengajuan Mobil Baru/Baru/Cash_Radio'), 0, FailureHandling.STOP_ON_FAILURE)
}

Mobile.delay(2, FailureHandling.STOP_ON_FAILURE)

if (CreditProtection == 'Yes') {
    Mobile.checkElement(findTestObject('Buat Pengajuan Mobil Baru/Baru/ACC_CASH_PROTECTION_CHECKBOX'), 0)
} else if (CreditProtection == 'No') {
    Mobile.uncheckElement(findTestObject('Buat Pengajuan Mobil Baru/Baru/ACC_CASH_PROTECTION_CHECKBOX'), 0)
}
...
if (Mobile.verifyElementVisible(findTestObject('Buat Pengajuan Mobil Baru/Lama/Alert_Cabang_Harus_Diisi'), 0, FailureHandling.OPTIONAL)) {
    ...
    Mobile.tap(findTestObject('Buat Pengajuan Mobil Baru/Baru/Simpan_Simulasi_BTN'), 0)

    not_run: Mobile.tap(findTestObject('Buat Pengajuan Mobil Baru/Lama/Saya_Tertarik_BTN'), 0)

    Mobile.tap(findTestObject('Buat Pengajuan Mobil Baru/Baru/Ajukan_Unit_Sekarang_BTN'), 0)

    if (Mobile.verifyElementVisible(findTestObject('Buat Pengajuan Mobil Baru/Lama/Alert_Perhitungan_Belum_Diisi'), 0, FailureHandling.OPTIONAL)) {
        ...
        if (DP == 'Persen') {
            ...
            if (Mobile.verifyElementVisible(findTestObject('Buat Pengajuan Mobil Baru/Lama/30Persen', [('text') : DPPersen]), 
        ...
        if (Mobile.verifyElementVisible(findTestObject('Buat Pengajuan Mobil Baru/Lama/Alert_Cabang_Harus_Diisi'), 0, FailureHandling.OPTIONAL)) {
            Mobile.verifyElementVisible(findTestObject('Buat Pengajuan Mobil Baru/Lama/SimpanSimulasi'), 0, FailureHandling.STOP_ON_FAILURE)
        } else if (Mobile.verifyElementVisible(findTestObject('Buat Pengajuan Mobil Baru/Lama/Alert_DP_Harus_Diisi'), 0, 
            FailureHandling.OPTIONAL)) {
            not_run: Mobile.verifyElementVisible(findTestObject('Buat Pengajuan Mobil Baru/Lama/SimpanSimulasi'), 0, FailureHandling.STOP_ON_FAILURE)
        } else if (Mobile.verifyElementVisible(findTestObject('Buat Pengajuan Mobil Baru/Lama/Alert_DP_Min20'), 0, FailureHandling.OPTIONAL)) {
            Mobile.verifyElementVisible(findTestObject('Buat Pengajuan Mobil Baru/Lama/SimpanSimulasi'), 0, FailureHandling.STOP_ON_FAILURE)
        } else if (Mobile.verifyElementVisible(findTestObject('Buat Pengajuan Mobil Baru/Lama/Alert_Uang_Muka_20dariOTR'), 
            0, FailureHandling.OPTIONAL)) {
            Mobile.verifyElementVisible(findTestObject('Buat Pengajuan Mobil Baru/Lama/SimpanSimulasi'), 0, FailureHandling.STOP_ON_FAILURE)
        } else {
            Mobile.tap(findTestObject('Buat Pengajuan Mobil Baru/Lama/SimpanSimulasi'), 0)

            Mobile.tap(findTestObject('Buat Pengajuan Mobil Baru/Lama/Saya_Tertarik_BTN'), 0)

            Mobile.tap(findTestObject('Buat Pengajuan Mobil Baru/Lama/Ajukan_Sekarang_Btn'), 0)
        }
    } else {
        Mobile.setText(findTestObject('Buat Pengajuan Mobil Baru/Baru/Catatan'), 'TEST', 0)

        Mobile.checkElement(findTestObject('Buat Pengajuan Mobil Baru/Baru/ChekkBox_Setuju'), 0)

        Mobile.tap(findTestObject('Buat Pengajuan Mobil Baru/Baru/Ajukan_Sekarang_BTN'), 0)
    }
}
