...
if (Mobile.verifyElementVisible(null, 0, FailureHandling.OPTIONAL)) {
    ...
    Mobile.verifyElementVisible(findTestObject('Verifikasi Akun - ATS-11/Ongoing Verification'), 0)
} else {
    Mobile.verifyElementVisible(findTestObject('Verifikasi Akun - ATS-11/Documents Verified Notif'), 0)
}
