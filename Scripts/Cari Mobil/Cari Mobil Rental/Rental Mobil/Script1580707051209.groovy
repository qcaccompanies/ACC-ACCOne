...
Mobile.swipe(40, 1080, 40, 700)

Mobile.setText(findTestObject('Cari Mobil/Mobil Rental/Dropdown Brand'), brand, 0)

if (status.toString() == 'failed') {
    WebUI.callTestCase(findTestCase('Cari Mobil/Cari Mobil Rental/Verify Fail Rental Mobil'), [('condition') : condition], 
...
switch (periodeLeasing.toString()) {
    case '12':
        Mobile.tap(findTestObject('Cari Mobil/Mobil Rental/12'), 0)

        break
    case '24':
        Mobile.tap(findTestObject('Cari Mobil/Mobil Rental/24'), 0)

        break
    case '36':
        Mobile.tap(findTestObject('Cari Mobil/Mobil Rental/36'), 0)

        break
    case '48':
        Mobile.tap(findTestObject('Cari Mobil/Mobil Rental/48'), 0)

        break
    case '60':
        Mobile.tap(findTestObject('Cari Mobil/Mobil Rental/60'), 0)
